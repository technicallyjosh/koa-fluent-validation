...
export class ValidatorBuilder implements Validators {
  ...
  public email(options?: v.IsEmailOptions): Validators {
    return this.addValidator(
      ({ value }: ValidatorContext, options: v.IsEmailOptions) =>
  ...
  public float(strict = false, options?: v.IsFloatOptions): Validators {
    return this.addValidator(
      (
        { value }: ValidatorContext,
        strict: boolean,
        options?: v.IsFloatOptions,
      ) => {
        if (!exists(value)) {
          return true;
        }
  ...
  public currency(options?: v.IsCurrencyOptions): Validators {
    return this.addValidator(
      ({ value }: ValidatorContext, options?: v.IsCurrencyOptions) =>
  ...
  public int(strict = false, options?: v.IsIntOptions): Validators {
    return this.addValidator(
      (
        { value }: ValidatorContext,
        strict: boolean,
        options?: v.IsIntOptions,
      ) => {
        if (!exists(value)) {
          return true;
        }
  ...
  public url(options?: v.IsURLOptions): Validators {
    return this.addValidator(
      ({ value }: ValidatorContext, options?: v.IsURLOptions) =>
        !exists(value)
          ? true
  ...
  public mobilePhone(locale: v.MobilePhoneLocale = 'en-US'): Validators {
    return this.addValidator(
      ({ value }: ValidatorContext, locale: v.MobilePhoneLocale) =>
  ...
  public ipAddress(version?: '4' | '6'): Validators {
    return this.addValidator(
      ({ value }: ValidatorContext, version?: '4' | '6') =>
